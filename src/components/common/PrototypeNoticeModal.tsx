    ...
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 z-50 overflow-y-auto">
          ...
          {/* Centering Wrapper ensuring no top clipping on any viewport */}
          <div className="min-h-full flex items-center justify-center p-4 sm:p-6">
            <motion.div
              ...
              className="relative z-10 w-full max-w-lg bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-2xl overflow-hidden flex flex-col my-auto"
            >
              {/* Header */}
